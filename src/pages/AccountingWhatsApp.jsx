...
const BOOKING_URL = 'https://contact-finanshels.zohobookings.com/#/accounting-consultation';
...
const CtaButtons = ({ onWhatsAppClick, source }) => (
  <div className="cta-buttons">
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="cta-button cta-button-whatsapp data-wa-track"
      onClick={() => onWhatsAppClick(source)}
    >
          ...
          <div className="hero-grid">
            ...
            <div className="hero-form-wrapper">
              <div className="hero-form-card">
                ...
                <CtaButtons onWhatsAppClick={trackWhatsAppClick} source="hero_cta" />
                
                <p className="form-privacy">
                  We usually reply within minutes on WhatsApp. Your data is secure and will never be shared.
                </p>
              </div>
            </div>
          ...
          <div className="final-cta-content">
            ...
            <div className="final-cta-right">
              <div className="consultation-card">
                ...
                <p className="card-subtitle">Message us on WhatsApp or book a 30-minute call with our finance experts. No obligation.</p>
                
                <CtaButtons onWhatsAppClick={trackWhatsAppClick} source="final_cta" />
...
export default AccountingWhatsApp;
