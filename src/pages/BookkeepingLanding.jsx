  ...
  const faqs = [
    {
      ...
      answer: 'We manage your complete Corporate Tax lifecycle - from quarterly compliances to annual book closure. Our team stays updated with the latest UAE tax regulations to ensure 100% compliance and help you avoid penalties.'
    },
    {
        ...
        <div className="content-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              ...
              tax compliances. Yet here you are, spending hours on tasks that drain your energy.
            </p>
          </div>
